...
const NoteCard = ({note,setNotes}) => {
  ...
  const handleDelete = async(e,id)=>{
    ...
    try {
      ...
      console.error(error);
      toast.error('Error deleteing the post')
      ...
      <div className='card-body'>
        ...
        <div className='card-actions justify-between items-center mt-4'>
          ...
          <div className='flex items-center gap-1'>
            ...
            <button className='btn btn-ghost btn-xs text-error'><Trash2Icon onClick={(e)=>handleDelete(e,note._id)} className='size-4'/></button>
          </div>
        </div>
      </div>
    </Link>
